...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x, get_inter=False):
        ...
        b1a = self.scala1(b1).view(x.size(0), -1)
        b2a = self.scala2(b2).view(x.size(0), -1)
        b3a = self.scala3(b3).view(x.size(0), -1)
        ...
        if get_inter:
            return b1a, b2a, b3a, b4a, b1aout, b2aout, b3aout, b4aout
        else:
            return h
