...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=2, zero_init_residual=False,
        ...
        self.fc1 = nn.Linear(12800 * block.expansion, num_classes)
        self.fc2 = nn.Linear(12800 * block.expansion, num_classes)
        self.fc3 = nn.Linear(12800 * block.expansion, num_classes)
    ...
    def forward(self, x):
        ...
        # out1_feature = feature_list[0]
        # out2_feature = feature_list[1]
        # out3_feature = feature_list[2]
        ...
        out2 = 0
        out3 = 0
        x = self.avgpool(out4_feature)
        x = torch.flatten(x, 1)
        out4 = self.fc4(x)

        return out1_feature, out2_feature, out3_feature, out4_feature, out1, out2, out3, out4
