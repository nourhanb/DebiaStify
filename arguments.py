...
def get_args():
    ...
    parser.add_argument('--dataset', required=False, default='celeba', choices=['utkface', 'celeba', 'cifar10'])
    ...
    parser.add_argument('--method', default='scratch', type=str, required=False,
    ...
    parser.add_argument('--model', default='resaligned', required=False, choices=['resnet', 'shufflenet', 'mlp', 'cifar_net', 'resaligned'])
    ...
    parser.add_argument('--target', default='Brown_Hair', type=str, help='target attribute for celeba')
